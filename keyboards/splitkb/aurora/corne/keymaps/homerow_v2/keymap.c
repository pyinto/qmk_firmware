...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_split_3x6_3(
    ...
    // ⎟---------+---------+---------+---------+---------+---------⎟ ⎟---------+---------+---------+---------+---------+---------⎟
        KC_GRAVE ,  HOME_A ,  HOME_S ,  HOME_D ,  HOME_F ,    KC_G ,      KC_H ,  HOME_J ,  HOME_K ,  HOME_L ,HOME_SCLN, KC_QUOT ,
    // ⎟---------+---------+---------+---------+---------+---------⎟ ⎟---------+---------+---------+---------+---------+---------⎟
  ...
  [_RAISE] = LAYOUT_split_3x6_3(
    ...
    // ⎟---------+---------+---------+---------+---------+---------⎟ ⎟---------+---------+---------+---------+---------+---------⎟
         _______ , KC_LCTL , KC_LALT , KC_LGUI , KC_LSFT , KC_GRAVE,   KC_LEFT , KC_DOWN ,   KC_UP , KC_RGHT , KC_UNDS , _______ ,
    // ⎟---------+---------+---------+---------+---------+---------⎟ ⎟---------+---------+---------+---------+---------+---------⎟
  ...
  [_ADJUST] = LAYOUT_split_3x6_3(
    // ╭---------+---------+---------+---------+---------+---------╮ ╭---------+---------+---------+---------+---------+---------╮
         RGB_TOG , _______ , _______ , _______ , _______ ,  QK_RBT ,   _______ ,   KC_F7 , KC_F8   , KC_F9   , KC_F10  ,  KC_F13 ,
    // ⎟---------+---------+---------+---------+---------+---------⎟ ⎟---------+---------+---------+---------+---------+---------⎟
