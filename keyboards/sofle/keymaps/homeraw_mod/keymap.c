...
[_LOWER] = LAYOUT(
  ...
  _______, KC_LCTL , KC_LALT, KC_LGUI, KC_LSFT,_______,                      KC_PEQL, KC_4   , KC_5   , KC_6   , KC_0   , KC_PDOT,
...
[_RAISE] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______,                      KC_LBRC, KC_LCBR, KC_RCBR, KC_RBRC, _______, _______,
