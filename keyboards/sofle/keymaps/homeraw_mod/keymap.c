...
[_RAISE] = LAYOUT(
  ...
  _______, _______, _______, KC_LCBR, KC_RCBR, _______,                      _______, KC_LBRC, KC_RBRC, KC_LPRN, KC_RPRN, KC_BSLS,
  _______, _______, _______, KC_LBRC, KC_RBRC, _______,                      KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, _______, _______,
  _______, _______, _______, KC_LPRN, KC_RPRN, _______, _______,    _______, KC_MINS, KC_UNDS, KC_PEQL, KC_PPLS, _______, _______,
                    _______, _______, _______, _______, _______,    _______, _______, _______, _______, _______
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
