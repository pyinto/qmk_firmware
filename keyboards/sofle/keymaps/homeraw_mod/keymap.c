...
[_RAISE] = LAYOUT(
  ...
  _______, KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, _______,                      KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, KC_UNDS, _______,
  _______, KC_PIPE, KC_CIRC, KC_AMPR, KC_HASH, KC_TILD, _______,    _______, _______, KC_LPRN, KC_RPRN, _______, _______, _______,
                    _______, _______, _______, _______, _______,    _______, _______, _______, _______, _______
),
