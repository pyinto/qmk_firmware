...
//MT(MOD_RSFT, KC_J), MT(MOD_RGUI, KC_K), MT(MOD_RALT, KC_L), MT(MOD_RCTL, KC_SCLN),
...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , KC_MUTE,    XXXXXXX, KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_RSFT,
                    XXXXXXX, XXXXXXX, KC_LOWER,KC_LGUI, KC_ENT ,    KC_SPC , KC_RAISE, XXXXXXX, XXXXXXX, XXXXXXX
),
...
[_LOWER] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______, _______,    _______, KC_PSLS, KC_1   , KC_2   , KC_3   , KC_PMNS, _______,
...
[_RAISE] = LAYOUT(
  ...
  _______, _______, _______, KC_LPRN, KC_RPRN, _______, _______,    _______, _______, KC_UNDS, KC_PEQL, KC_PPLS, KC_MINS, _______,
                    _______, _______, _______, _______, _______,    _______, _______, _______, _______, _______
),
