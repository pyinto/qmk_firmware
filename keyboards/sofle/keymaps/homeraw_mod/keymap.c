...
[_LOWER] = LAYOUT(
  _______, _______, _______, _______, _______, _______,                      _______, _______, _______, _______, _______, _______,
  _______, KC_PAST, KC_PLUS, KC_MINS, KC_PEQL, _______,                      _______, KC_7   , KC_8   , KC_9   , _______, KC_DEL  ,
  _______, KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, _______,                      _______, KC_4   , KC_5   , KC_6   , KC_0   , _______,
  _______, _______, KC_CIRC, KC_PERC, _______, _______, _______,    _______, _______, KC_1   , KC_2   , KC_3   , KC_PDOT, _______,
...
[_RAISE] = LAYOUT(
  ...
  _______, KC_PIPE, KC_AMPR, KC_HASH, KC_MINS, KC_TILD, _______,    _______, KC_LABK, KC_LPRN, KC_RPRN, KC_RABK, _______, _______,
