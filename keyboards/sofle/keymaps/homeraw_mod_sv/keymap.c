...
[_LOWER] = LAYOUT(
  ...
  _______, _______, KC_CIRC, KC_PERC, KC_MINS, _______, _______,    _______, _______, KC_1   , KC_2   , KC_3   , KC_PDOT, _______,
...
[_RAISE] = LAYOUT(
  ...
  _______, KC_PIPE, KC_AMPR, KC_GRV , KC_HASH, _______, _______,    _______, KC_LABK, KC_LPRN, KC_RPRN, KC_RABK, _______, _______,
